...
**网站(下载)：恢复蓝奏云提取码 1698（撤销测试版免密）**（commit ）

### 网站

- **全版本下载描述恢复「提取码 1698」** — `docs/data/versions.json` 10 条下载描述（26w33a/26w33b × Windows/Android/Linux/mac Apple 芯片/mac Intel）补回「· 提取码 1698 ·」；26w33b `log` 移除「测试版下载链接不再需要访问提取码，下载更省心」条目（蓝奏云非会员只能使用访问密码，撤销此前免密决定）（commit ）
- **PUBLISH.md 26w33b 摘要移除免密说明** — 面向玩家摘要删除「测试版下载链接不再需要访问提取码，下载更省心」（commit ）
