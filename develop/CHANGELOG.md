...
**文档(发布)：按 commit 区间细化 26w33b 发布说明**

### 文档

- **26w33b 更新说明补全为 commit 区间梳理** — `docs/data/versions.json` 版本 2 的 `log` 与 `PUBLISH.md` 面向玩家摘要，按 26w33a 发布点（`adf2635`）→ 26w33b 发布点（`9500e9d`）之间的 commit 区间梳理，补入区间内完成的 mac 卡死修复（点击路径打开资源管理器 / 系统原生弹窗）与 mac 安装包引导改进
