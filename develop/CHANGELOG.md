...
**网站(beta)：下载区更新为 26w33b 免密链接**

### 网站

- **versions.json 新增 v1.0.0-beta-26w33b 条目** — 新增 `versions."2"`（newest_version=2 / 26w33b），Windows、Android、Linux、mac Apple 芯片、mac Intel 五处蓝奏云下载链接全部更新为 26w33b 免密地址
- **测试版下载取消访问提取码** — 按新策略测试版链接不再设置访问密码，26w33b 五条描述移除「提取码 1698」文案；旧版 26w33a 链接（上传时仍设密码）描述保留提取码
- **26w33b 更新摘要细化** — 版本 `log` 字段改写为详细更新说明（版本判定升级 / 修复误弹「版本不一致」/ 新增「无法识别游戏版本要求」提示 / 测试版下载免密）
