...
public class LogicValueCommand implements ValueCommand
{
    ...
    static
    {
        ...
        ACTION_PARAM_MAP.put(ValueCommandAction.AND, AndLogicValueCommandParam.class);
        ACTION_PARAM_MAP.put(ValueCommandAction.OR, OrLogicValueCommandParam.class);
        ACTION_PARAM_MAP.put(ValueCommandAction.NOT, NotLogicValueCommandParam.class);
    }

    // ============================================================================

    public LogicValueCommand (ValueCommandAction valueCommandAction, ValueCommandParam valueCommandParam)
    {
        this.valueCommandType = ValueCommandType.LOGIC;
