...
public class FadeOutObject
{
    ...
    private void buildJson ()
    {
        ...
        if (!synchronizationTasks.isEmpty() || !scheduleTasks.isEmpty())
        {
            ...
            taskJson.put(AnimationKey.Component.FadeOut.SYNCHRONIZATION, taskToJsonList(synchronizationTasks));
            taskJson.put(AnimationKey.Component.FadeOut.SCHEDULE, taskToJsonList(scheduleTasks));
     ...
     */
    public FadeOutObject (float duration, Set<AnimationTask> synchronizationTasks, List<AnimationTask> scheduleTasks)
    {
    ...
    {
        if (json.isMap() && json.containsKey(AnimationKey.Component.FadeOut.DURATION))
        {
            ...
            this.synchronizationTasks = parseSynchronizationTasks(taskJson.getJsonEntityByKey(AnimationKey.Component.FadeOut.SYNCHRONIZATION));
            this.scheduleTasks = parseScheduleTasks(taskJson.getJsonEntityByKey(AnimationKey.Component.FadeOut.SCHEDULE));
            valid = true;
        }
        else
        {
