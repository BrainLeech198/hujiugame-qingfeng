...
| **官网版本数据维护规范** | [develop/DOC_STANDARD.md](develop/DOC_STANDARD.md) | 官网 versions.json 日期时间格式、更新日志内容取舍（只写玩家可感知）、跨版本修复补全、与其他文档联动 |
...
| **SceneStack 预加载改造** | [develop/plans/2026-08-23-scene-stack-preload.md](develop/plans/2026-08-23-scene-stack-preload.md) | 拆 updateGameState 为 preload + apply 两步，淡出期间后台线程预加载 JSON，消除切页卡顿 |
...
| **引擎分离架构设计** | [develop/plans/2026-08-29-engine-separation-design.md](develop/plans/2026-08-29-engine-separation-design.md) | 方案 C 务实分层：engine/platform 包拆分 + Application 生命周期 + EventBus 统一 + SceneManager 协调 + 5 阶段迁移 |
