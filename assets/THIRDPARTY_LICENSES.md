...
如无特殊说明，项目自有代码和素材以根目录 `LICENSE`（官方英文原文，CC BY-NC 4.0 非商业许可）为准，中文版见 `LICENSE.zh-CN`（简体）/ `LICENSE.zh-TW`（繁体）。
...
| `asset/resource/image/controller_cursor.png` | 手柄光标 | 稍作修改 |
| `asset/resource/image/keyboard_button_enter.png` | 键盘回车键图符 | 稍作修改 |
| `asset/resource/image/keyboard_button_escape.png` | 键盘 ESC 键图符 | 稍作修改 |
| `asset/resource/image/keyboard_button_enter_or_escape.png` | 键盘回车/ESC 图符 | 稍作修改 |

- **来源：** [豆包AI](https://www.doubao.com)
- **许可：** 视觉素材可商用（需二次设计后再使用）
- 以上均已进行二次设计（调整、整合、配色等），符合商用条件
...
- **文件：** `lwjgl3/setup/qfl.ico`
- **作者：** Free-psd-templates、Chanut（icon-icons.com）
- **来源：** [icon-icons.com - document-page-notes-text](https://icon-icons.com/icon/document-page-notes-text/122642)、[icon-icons.com - language-setting](https://icon-icons.com/icon/language-setting/159167)
- **许可：** icon-icons.com 免费许可（Free for commercial use，无需署名）
- **修改：** 是（以 document 为基础，整合 language-setting，替换为主题色 `#3F48CC` + 副主题色 `#FDA1FF`）

本图标使用了上述 icon-icons.com 素材，按免费许可使用：

- 可免费用于商业项目（Free for commercial use）
- 不强制署名（可选感谢作者）
- 不得作为独立文件转售、再许可或分发

#### 1.2.5 qfgl.ico（游戏语言包图标）

- **文件：** `lwjgl3/setup/qfgl.ico`
- **作者：** Free-psd-templates、Chanut（icon-icons.com）
- **来源：** [icon-icons.com - document-page-notes-text](https://icon-icons.com/icon/document-page-notes-text/122642)、[icon-icons.com - language-setting](https://icon-icons.com/icon/language-setting/159167)
- **许可：** icon-icons.com 免费许可（Free for commercial use，无需署名）
- **修改：** 是（qfl.ico 的配色互换变体，素材与来源同 qfl.ico）
...
- **文件：** `lwjgl3/setup/qft.ico`
- **作者：** Free-psd-templates、Google（icon-icons.com，Material 系列）
- **来源：** [icon-icons.com - document-page-notes-text](https://icon-icons.com/icon/document-page-notes-text/122642)、[icon-icons.com - color-lens](https://icon-icons.com/icon/color-lens/90605)
- **许可：** icon-icons.com 免费许可（Free for commercial use，无需署名）
- **修改：** 是（以 document 为基础，整合 color-lens，替换为主题色 `#3F48CC` + 副主题色 `#FDA1FF`）
...
#### 1.2.7 qfgt.ico（游戏主题包图标）

- **文件：** `lwjgl3/setup/qfgt.ico`
- **作者：** Free-psd-templates、Google（icon-icons.com，Material 系列）
- **来源：** [icon-icons.com - document-page-notes-text](https://icon-icons.com/icon/document-page-notes-text/122642)、[icon-icons.com - color-lens](https://icon-icons.com/icon/color-lens/90605)
- **许可：** icon-icons.com 免费许可（Free for commercial use，无需署名）
- **修改：** 是（qft.ico 的配色互换变体，素材与来源同 qft.ico）
...
- **文件：** `asset/theme/default_theme/asset/ui/font/Source_Han_Sans/`
- **作者：** Adobe 与 Google（Source Han Sans / Noto Sans CJK）
- **来源：** https://github.com/adobe-fonts/source-han-sans
- **许可：** [SIL Open Font License 1.1](https://scripts.sil.org/OFL)
- **修改：** 否（仅生成位图字体文件 `.fnt` + `.png`）
...
#### 1.3.2 Fugaz One（标题图渲染）

- **文件：** `asset/theme/default_theme/asset/resource/image/menu.title.png`
- **字体：** Fugaz One（Google Fonts）
- **作者：** LatinoType Limitada（Luciano Vergara）
- **来源：** [Google Fonts - Fugaz One](https://fonts.google.com/specimen/Fugaz+One)
- **许可：** [SIL Open Font License 1.1](https://openfontlicense.org)
- **修改：** 是（使用 Fugaz One 字体渲染为位图并整合到游戏界面中）

本图像使用 Fugaz One 字体渲染生成。字体本身受 SIL OFL 1.1 保护：

- 可免费用于个人和商业项目
- 可与其他软件捆绑分发
- 不得单独销售字体文件
- 衍生版本不得使用 "Fugaz One" 作为字体名称
...
本作品使用了乌鸦Producer提供的音乐素材，按作者要求声明如下：

**署名：**
> 音乐由乌鸦Producer提供
> 乌鸦的个人网站：https://crowproducer.ddns.net/
...
#### 2.2.1 UI_TextBlip_08（弹窗提示音效）

- **文件：** `asset/theme/default_theme/asset/resource/audio/message_box/849886__wavewire__ui_textblip_08.wav`
- **作者：** Wavewire
- **来源：** [Freesound](https://freesound.org/people/Wavewire/sounds/849886/)
- **许可：** [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)
- **修改：** 否

本作品使用了 Wavewire 提供的音效素材，按 CC BY 4.0 许可要求声明如下：

**署名：**
> UI_TextBlip_08 by Wavewire — https://freesound.org/people/Wavewire/sounds/849886/
> 许可：CC BY 4.0 — https://creativecommons.org/licenses/by/4.0/

#### 2.2.2 Random Click 2（按钮点击音效）

- **文件：** `asset/theme/default_theme/asset/resource/audio/button/862694__cat-fox_alex__random-click-2.wav`
- **作者：** CAT-FOX_ALEX
- **来源：** [Freesound](https://freesound.org/people/CAT-FOX_ALEX/sounds/862694/)
